...
multiInfo:"small",multiRestore:"ui message multi-restore"},inline:{wrapper:"DTE DTE_Inline ui form"},bubble:{table:"DTE_Bubble_Table ui form",bg:"ui dimmer modals pages transition visible active"}});c.extend(!0,a.ext.buttons,{create:{formButtons:{className:"primary"}},edit:{formButtons:{className:"primary"}},remove:{formButtons:{className:"negative"}}});a.Editor.display.semanticui=c.extend(!0,{},a.Editor.models.displayController,{init:function(a){b._dom.modal||(b._dom.modal=c('<div class="ui modal DTED"></div>'),
b._dom.close=c('<i class="close icon"/>').click(function(a){b._dte.close("icon");return!1}),c(d).on("click","div.ui.dimmer.modals",function(a){c(a.target).hasClass("modal")&&b._shown&&b._dte.background()}));return b},open:function(a,d,e){if(b._shown)e&&e();else{b._dte=a;b._shown=!0;a=b._dom.modal;var f=c(d).children();a.children().detach();a.append(f).prepend(a.children(".header")).addClass(d.className).prepend(b._dom.close);c(b._dom.modal).modal("setting",{autofocus:!1,dimmerSettings:{closable:!1},
onVisible:function(){b._dte.s.setFocus&&b._dte.s.setFocus.focus();e&&e()},onHidden:function(){c(d).append(f);b._shown=!1}}).modal("show")}},close:function(a,c){var d=b._dom.modal;b._shown&&(d.modal("hide"),b._dte=a,b._shown=!1);c&&c()},node:function(a){return b._dom.modal[0]},_shown:!1,_dte:null,_dom:{}});var b=a.Editor.display.semanticui;return a.Editor});
