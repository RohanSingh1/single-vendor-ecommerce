...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    InteractiveDateComponent.prototype.bindDateHandlerToEl = function (el, name, handler) {
        ...
        this.el.on(name, function (ev) {
            if (!$(ev.target).is(_this.segSelector + ':not(.fc-helpers),' + // directly on an event element
                _this.segSelector + ':not(.fc-helpers) *,' + // within an event element
                '.fc-more,' + // a "more.." link
...
var HelperRenderer = /** @class */ (function () {
    ...
    HelperRenderer.prototype.renderEventFootprints = function (eventFootprints, sourceSeg, extraClassNames, opacity) {
        var segs = this.component.eventFootprintsToSegs(eventFootprints);
        var classNames = 'fc-helpers ' + (extraClassNames || '');
        var i;
...
function makeDayGridSubclass(SuperClass) {
    return /** @class */ (function (_super) {
        ...
        // Affects helpers-skeleton and highlight-skeleton rows.
        ...
        var dragListener = this.dragListener = new HitDragListener_1.default(view, {
            ...
            hitOver: function (hit, isOrig, origHit) {
                ...
                if (eventDefMutation &&
                    ...
                    mouseFollower.hide(); // if the subclass is already using a mock event "helpers", hide our own
                }
                else {
                    mouseFollower.show(); // otherwise, have the helpers follow the mouse (no snapping)
                }
                if (isOrig) {
...
var AgendaView = /** @class */ (function (_super) {
    ...
    ------------------------------------------------------------------------------------------------------------------*/
    // A returned value of `true` signals that a mock "helpers" event has been rendered.
...
agendaTimeGridMethods = {
    ...
    // Affects content-skeleton, helpers-skeleton, highlight-skeleton for both the time-grid and day-grid.
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderContentSkeleton = function () {
        ...
        for (i = 0; i < this.colCnt; i++) {
            cellHtml +=
                '<td>' +
                    ...
                    '<div class="fc-event-container fc-helpers-container"></div>' +
                    '<div class="fc-event-container"></div>' +
        ...
        this.helperContainerEls = skeletonEl.find('.fc-helpers-container');
        this.fgContainerEls = skeletonEl.find('.fc-event-container:not(.fc-helpers-container)');
    ...
    TimeGrid.prototype.renderDrag = function (eventFootprints, seg, isTouch) {
        ...
        if (seg) {
            if (eventFootprints.length) {
                this.helperRenderer.renderEventDraggingFootprints(eventFootprints, seg, isTouch);
                // signal that a helpers has been rendered
                return true;
            }
        }
        else {
...
var DayGridHelperRenderer = /** @class */ (function (_super) {
    ...
    // Renders a mock "helpers" event. `sourceSeg` is the associated internal segment object. It can be null.
    DayGridHelperRenderer.prototype.renderSegs = function (segs, sourceSeg) {
        ...
        this.component.rowEls.each(function (row, rowNode) {
            ...
            var skeletonEl = $('<div class="fc-helpers-skeleton"><table/></div>'); // will be absolutely positioned
            var skeletonTopEl;
            var skeletonTop;
