    ...
    public function destroy(DeliveryName $delivery_name)
    {
        try {
            ...
            if ($e->getCode() == "23000") { //23000 is sql code for integrity constraint violation
                return redirect()->route('admin.delivery_name.index')->with('error', 'Cannot delete delivery_name because product exists with this delivery_name, delete the product first then you can delete this delivery_name');
            }
        }
    }
}
